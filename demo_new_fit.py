...
# plt.plot(OH.Fev_upper, _origin_distribution/OH.gJ_upper, marker='.')
# plt.plot(OH.Fev_upper, popt/OH.gJ_upper, marker='.')
# print(_distribution)
# print(popt)
